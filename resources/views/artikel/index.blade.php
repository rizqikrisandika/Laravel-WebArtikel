...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col col-md-6">
            <a class="btn btn-primary mt-4" style="float: right" href="{{route('create.artikel')}}">Add Data</a>
        </div>
    </div>
        ...
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset('media/'.$artikel->image)}}" style="max-height:100px;max-width:100px;" alt=""srcset="">
                    </td>
